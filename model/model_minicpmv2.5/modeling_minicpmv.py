...
from .modeling_idefics2 import Idefics2VisionTransformer
...
class MiniCPMV(MiniCPMVPreTrainedModel):
    ...
    def generate(
        ...
        **kwargs
        ...
        model_inputs = self._process_list(
            tokenizer,
            input_id_list,
            max_inp_length)
