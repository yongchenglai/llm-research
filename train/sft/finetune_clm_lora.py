...
class DataTrainingArguments:
    """
    Arguments pertaining to what data we are going to
    input our model for training and eval.
    """
    ...
    keep_linebreaks: bool = field(
        default=True,
        metadata={"help": "Whether to keep line breaks "
...
def main():
    ...
    # allocate resources to maintain them. The information sent is
    # the one passed as arguments along with your Python/PyTorch versions.
